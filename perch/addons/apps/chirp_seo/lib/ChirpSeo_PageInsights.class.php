...
class ChirpSeo_PageInsights extends ChirpSeo_Base
{
  ...
  public function calculate_score() {
    ...
    $this->result = $results;
    $this->score = $results["lighthouseResult"]["categories"]["performance"]["score"] * 100;
  }
  ...
  public function get_description() {
    ...
    $description = PerchLang::get("Your Google PageSpeed insights score is %s, view feedback %shere%s.", $this->score, '<a href="https://developers.google.com/speed/pagespeed/insights/?url=' . $this->url . '&tab=desktop" target="_blank">', '</a>');
